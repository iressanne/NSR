...
class Article {
  ...
  */
  ...
  public function __construct( $data = array() ) {
    ...
    if ( isset( $data['post_title'] ) ) $this->post_title = preg_replace ( "/[^\.\,\-\_\'\"\@\?\!\:\$ a-zA-Z0-9()]/", "", $data['post_title'] );
    if ( isset( $data['post_cover'] ) ) $this->post_cover = $data['post_cover'];
    if ( isset( $data['post_heading'] ) ) $this->post_heading = preg_replace ( "/[^\.\,\-\_\'\"\@\?\!\:\$ a-zA-Z0-9()]/", "", $data['post_heading'] );
  ...
  */
  ...
  public function insert() {
    ...
    $sql = "INSERT INTO posts ( post_date, post_title, post_heading, post_content ) VALUES ( FROM_UNIXTIME(:post_date), :post_title, :post_heading, :post_content )";
  ...
  */
  ...
  public function update() {
    ...
    // Connexion à la base de données
    $conn = new PDO( DB_DSN, DB_USERNAME, DB_PASSWORD );
    // On met à jour l'Article via une requète SQL
